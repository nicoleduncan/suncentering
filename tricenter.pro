...
;
; :Examples:
;       cropped = cropit(region=1,inputarr=image,sundiam=sundiam,scan_width=scan_width,thresh=thresh)
;
;-
...
finish = systime(1,/s)
IF keyword_set(time) THEN  print, 'Elapsed Time for trimask: ',strcompress(finish-start,/remove),' seconds'
RETURN
