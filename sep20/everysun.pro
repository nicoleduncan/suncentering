...
limbxstrips = REPLICATE({limbxstrips, rowwhere:BYTARR(2), startindex:0, endindex:0, startpoints:BYTARR( !param.ministrip_length), endpoints:BYTARR( !param.ministrip_length), $
    startloc:BYTARR( !param.ministrip_length), endloc:BYTARR( !param.ministrip_length), isitbad:0}, !param.nstrips)
limbystrips = REPLICATE({limbystrips, colwhere:BYTARR(2), startindex:0, endindex:0, startpoints:BYTARR( !param.ministrip_length), endpoints:BYTARR( !param.ministrip_length), $
    startloc:BYTARR( !param.ministrip_length), endloc:BYTARR( !param.ministrip_length), isitbad:0}, !param.nstrips)
; limbxstrips = REPLICATE({limbxstrips, startindex:0, endindex:0, startpoints:BYTARR( !param.ministrip_length), endpoints:BYTARR( !param.ministrip_length), $
;     startloc:BYTARR( !param.ministrip_length), endloc:BYTARR( !param.ministrip_length), isitbad:0}, !param.nstrips)
; limbystrips = REPLICATE({limbystrips, startindex:0, endindex:0, startpoints:BYTARR( !param.ministrip_length), endpoints:BYTARR( !param.ministrip_length), $
;     startloc:BYTARR( !param.ministrip_length), endloc:BYTARR( !param.ministrip_length), isitbad:0}, !param.nstrips)
