...
;   Compared to scanbox, scanboxv2 uses knowledge of approx size of sun to only scan
;   until it hits the sun then moves the crop borders based on the given parameters.
;
; :Keywords:
...
;       Differs from comp2 in that this one uses a much, much more beautiful way to create the mask
;
; :Keywords:
;   file: in, optional, type=string, default='104533_20120911_153147_254618_0.bin'
;       File to be read in
...
; BEWARE:
; comp2v2 takes into account all pixels above acertain threshold, including fiducial marks. comp6v2 
...
;       About their actual values, like in comp2v2. More "accurate" to find the
;       center than comp2v2 since this gives all solar pixels equal weighting.
;
; :Keywords:
;   file: in, optional, type=string, default='104533_20120911_153147_254618_0.bin'
;       File to be read in
...
; :Description:
;           Looks only at the positions of pixels above a threshold and doen't care
;       about their actual values, like in comp2v2. Different from comp3 in that this
;       version uses sort instead of the 2d array where
;
; :Keywords:
;   file: in, optional, type=string, default='104533_20120911_153147_254618_0.bin'
;       File to be read in
