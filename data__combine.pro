FUNCTION data::combine, scan_width, sigmavalue, sundiam, time=time
;+
;   :Description:
...
c1temp = self->center(scan_width,sigmavalue,sundiam,region=1,time=time)
center1 = c1temp->get()
c2temp = self->center(scan_width,sigmavalue,sundiam,region=2,time=time)
center2 = c1temp->get()
c3temp = self->center(scan_width,sigmavalue,sundiam,region=3,time=time)
center3 = c1temp->get()
