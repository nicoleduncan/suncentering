...
;+
; :Description:
;           Only used to save the cut-down strips into structures. Doesn't import
;           the whole strip data from comp4, it goes straight from scanbox (skips comp4). 
;
; :Keywords:
;   file: in, optional, type=string, default='104533_20120911_153147_254618_0.bin'
;       File to be read in
...
save,xstrips,ystrips,thresh,scan_width,sigmavalue,ministrip_length,filename='comp5strips.sav',/compress
...
;+
; :Description:
;       Uses the data from comp5 and draws a linear/quadratic/cubic/etc. function to find midpoint.
...
save,xpos,ypos,filename='comp6results.sav',/compress
RETURN
END
...
;   values for each blur amount. The only thing that changes the fit considerably is what order poly-
;   nomial I use.
;
;-
